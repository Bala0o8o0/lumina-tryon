...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function generateColor() {
      // Pink and Violet blend palette
      const pink = { r: 0.925, g: 0.282, b: 0.6 };   // #ec4899 pink
      const violet = { r: 0.545, g: 0.361, b: 0.965 }; // #8b5cf6 violet

      // Blend pink and violet
      const blend = Math.random();
      const color = {
        r: pink.r * blend + violet.r * (1 - blend),
        g: pink.g * blend + violet.g * (1 - blend),
        b: pink.b * blend + violet.b * (1 - blend)
      };


      // Apply intensity multiplier for visibility (increased for brighter colors)
